...
|---|---|---|---|---|
| data-download | GET | varies | <https://arcticdata.io/metacat/d1/mn/v2/object/{pid}> | curl -o data.zip 'https://arcticdata.io/metacat/d1/mn/v2/object/doi%3A10.18739%2FA2Q23R20H' |
| landing | GET | text/html | <https://arcticdata.io/catalog/view/{pid}> | open 'https://arcticdata.io/catalog/view/doi:10.18739/A2PR7MW2P' |
